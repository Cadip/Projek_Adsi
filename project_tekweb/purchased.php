...
<div class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            <!-- half-screen-text -->
            <div class="half-screen-text" style="height: 50vh; display: flex; align-items: center; justify-content: center;">
                <h1>Thankyou For Your Purchase</h1>
            </div>
            <div class="half-screen-text" style="display: flex; align-items: center; justify-content: center;">
              <a href="Home.php" class="primary-btn order-submit">Home</a>
            </div>
