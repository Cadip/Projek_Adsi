<?php
	...
	$query1 = "SELECT * FROM item WHERE id_item='7'";
	$stmt = $conn->query($query1);
	$row1 = $stmt->fetch();

	$query2 = "SELECT * FROM item WHERE id_item='8'";
	$stmt = $conn->query($query2);
	$row2 = $stmt->fetch();

	$query3 = "SELECT * FROM item WHERE id_item='9'";
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="add-to-cart">
												<button class="add-to-cart-btn" name="3"><i class="fa fa-shopping-cart"></i> add to cart</button>
											</div>
										</div>
										<!-- /product -->
									</div>
