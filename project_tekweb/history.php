...
<body>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-7">
					<div class="Hisory-list">
						<div class="section-title">
							<h3 class="title">Your History</h3>
						</div>
					</div>
					<table>
						<thead>
						...
						<tbody>
							<!-- Isi tabel akan ditambahkan menggunakan data dari database -->
							<?php
								$id = $_SESSION['id'];
								...
								while($row = $result->fetch()) {
									...
									echo "<td>" . $row["nama"] . "</td>";
									echo "<td>$" . $row["harga"] . ".00</td>";
									echo "</tr>";
								}
							?>
							<!-- Tambahkan baris sesuai data dari database -->
						</tbody>
					</table>
				</div>
			</div>
