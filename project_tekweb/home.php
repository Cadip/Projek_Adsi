<?php
	...
	$query3 = "SELECT * FROM item WHERE id_item='3'";
	...
	$query6 = "SELECT * FROM item WHERE id_item='6'";
	...
	$query8 = "SELECT * FROM item WHERE id_item='8'";
	$stmt = $conn->query($query8);
	$row8 = $stmt->fetch();

	$query9 = "SELECT * FROM item WHERE id_item='9'";
	$stmt = $conn->query($query9);
	$row9 = $stmt->fetch();
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="product-body">
												<h3 class="product-name"><a href="#"><?php echo $row6['item_name']; ?></a></h3>
												<h4 class="product-price">$<?php echo $row6['item_price']; ?></h4>
											</div>
											<div class="add-to-cart">
										...
										<div class="product">
											<div class="product-img">
												<img src="./img/barang8.png" alt="">
											</div>
											<div class="product-body">
												<h3 class="product-name"><a href="#"><?php echo $row8['item_name']; ?></a></h3>
												<h4 class="product-price">$<?php echo $row8['item_price']; ?></h4>
											</div>
											<div class="add-to-cart">
										...
										<div class="product">
											<div class="product-img">
												<img src="./img/barang9.png" alt="">
											</div>
											<div class="product-body">
												<h3 class="product-name"><a href="#"><?php echo $row9['item_name']; ?></a></h3>
												<h4 class="product-price">$<?php echo $row9['item_price']; ?></h4>
											</div>
											<div class="add-to-cart">
